...
labels = c( "DNA", "LINE", "LTR", "RC", "Sat/SR", "Unknown" )

p = ggplot( temp0 , aes( x=assembly, y=bp, color = Species ) ) %>% 
    + geom_point() %>% 
...
# pdf( file="faceted_class_correlation.pdf", width=9, height=7 )
# print( p )
# graphics.off()
...
#   theme_minimal(base_size = 20) + theme( legend.position = "bottom", axis.title.y=element_blank() ) + coord_flip()
# 
# ggsave( "class_lengths.pdf", width = 9, height = 12)
